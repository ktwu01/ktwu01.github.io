...
This is the working map for turning scattered work updates into a single source of truth that can flow into the right documents automatically.

Rendered assets: [PNG](figures/document-flow.png) and [SVG](figures/document-flow.svg).
...
The rule is simple: declare the fact once, then let the system update the right surfaces.
