...
[![GitHub stars](https://img.shields.io/github/stars/ktwu01/US-Survival-Guide?style=social)](https://github.com/ktwu01/US-Survival-Guide/stargazers) [![GitHub forks](https://img.shields.io/github/forks/ktwu01/US-Survival-Guide?style=social)](https://github.com/ktwu01/US-Survival-Guide/fork)
...
- **The 斩杀线 ("kill line")** — the financial point past which recovery becomes very hard, and how to stay above it.

## Read It

The full guide lives at [https://ktwu01.github.io/US-Survival-Guide/](https://ktwu01.github.io/US-Survival-Guide/). The repo is at [github.com/ktwu01/US-Survival-Guide](https://github.com/ktwu01/US-Survival-Guide).
...
This is a survival guide, not a doom guide. The US is an enormously generous country if you know how it works. The point of this document is to shorten the painful learning curve, not to scare anyone away.

## Contributing

If you've been through one of the traps and have advice that should be in the guide, open an issue or PR at [github.com/ktwu01/US-Survival-Guide](https://github.com/ktwu01/US-Survival-Guide). Every story makes the guide more useful for the next person.

---

The most expensive lessons are the ones you have to learn alone. The point of this guide is to make a few of them cheaper.
