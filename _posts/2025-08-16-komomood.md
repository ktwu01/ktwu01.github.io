...
# komomood – Elegant Pink Mood Diary

An elegant couple mood tracking website (self-hosted backend + SQLite) displaying daily mood records in GitHub contribution graph style.
...
- API proxy: `/komomood/api/` → `http://localhost:3002/api/`
