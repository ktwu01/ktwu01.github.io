---
title: 'NASA FINESST Resources Guide'
date: 2024-10-20
permalink: /posts/2024/10/nasa-finesst-guide/
tags:
  - nasa
  - graduate-research
  - funding
...
1. **Set Up NSPIRES**: Register at [nspires.nasaprs.com](https://nspires.nasaprs.com/external/index.do)
...
A: Yes, if enrolled at a U.S. institution. Check official guidelines.

**Q: Is NASA data required?**
A: Earth Science proposals must show clear link to NASA data (satellite data, airborne campaigns).

**Q: What is the typical selection rate?**
A: Usually around 15% across divisions (varies each cycle).
