---
title: 'Stock Commission Calculator - A股手续费计算器'
date: 2025-11-15
permalink: /posts/2025/11/stock-commission/
tags:
  - finance
  - calculator
  - stock-trading
...
一个单页计算器，方便估算买卖 A 股时的佣金、印花税、过户费和目标净回款。通过输入股票代码、手数、费率与目标收益，即可得到：

- 买入总成本(发生金额)与综合费率
- 卖出目标价或自定义卖价下的费用明细与综合费率
- 卖出净回款、资本收益、以及必要的"所需卖出价"提示

## 免责声明

本工具仅供学习与自我规划之用，不构成任何投资建议或商业用途。所有结果为估算值，可能与实际成交费用存在偏差。若不同意该声明，请勿使用。
